...
:::{.callout-step .callout-tip}
Open the **renamed.tree** file with **FigTree** (**File -> Open**) (file is in `/home/training/course_dir/work_dir/Day_2/binning`) and then
...
4. [personal usage only ] add clades drag and drop the files **iTOL_clades.txt** and **iTOL_ocircles.txt** present in /home/training/course_dir/work_dir/Day_2/binning/iTOL_Files/ into the browser window
