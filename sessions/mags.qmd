...
For this tutorial, you will need to first activate the virtual environment and
start the docker container by running the following commands in the terminal:

```bash
virtualenv /home/training/venv/training_env6/bin/activate
...
# plot
/usr/local/bin/complenetess_vs_contamination.py -i checkm1_quality_report.csv -o checkm1
```
:::
...
# plot
/usr/local/bin/complenetess_vs_contamination.py -i checkm1_quality_report.csv -o checkm2
```
:::
