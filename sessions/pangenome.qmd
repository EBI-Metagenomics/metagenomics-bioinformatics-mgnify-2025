...
```bash
(pangenome_mgnify_env) training@ip-172-17-32-100:~$
```
...
As well be working with `results`, copy the whole directory to your working directory : 
...
This will take some time. You'll see a number of tools being run, including [CheckM](https://github.com/Ecogenomics/CheckM) for completeness calculation, [MMseqs2](https://www.nature.com/articles/nbt.3988) for clustering, and [cgt](https://github.com/bacpop/cgt) for frequency threshold adjustment. 
